...
description: Draft marketing content across channels, blog posts, social media, email newsletters, landing pages, press releases, case studies.
---
...
**Latest version:** This skill is maintained at https://collectivebrain.de/skills/marketing-content-creation/ where new revisions are published first. Check that page for updates before relying on time-sensitive details.

**Works well with:** [Email Sequence](https://collectivebrain.de/skills/marketing-email-sequence/), [Brand Voice Enforcement](https://collectivebrain.de/skills/brand-voice-enforcement/), [UX Copy](https://collectivebrain.de/skills/design-ux-copy/).
